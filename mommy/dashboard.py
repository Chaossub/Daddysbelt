...
class MommyDashboardView(discord.ui.View):
    ...
    async def status(self, interaction: discord.Interaction, button: discord.ui.Button) -> None:
        ...
        body = (
            ...
            "Daddy's Belt is still handling the existing production features while Mommy.exe is brought online."
        )
    ...
    async def voice(self, interaction: discord.Interaction, button: discord.ui.Button) -> None:
        await self._edit(
            ...
            body="VC ownership is the next migration step. Daddy's existing voice system is intentionally left untouched in this first dual-bot build.",
            page="voice",
        )
...
def build_home_embed() -> discord.Embed:
    return discord.Embed(
        ...
        description=(
            ...
            "This is the first dual-bot build. AI/status controls are live; voice, automod, clips, follow mode, and verification are being migrated next."
        ),
    )
