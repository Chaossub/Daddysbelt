...
def _home_embed() -> discord.Embed:
    return discord.Embed(
        ...
        description=(
            ...
            "Mommy.exe keeps her voice/staff systems here and also has a separate member-games side. Staff can open the same game launcher from the **Games** button below."
        ),
    )
