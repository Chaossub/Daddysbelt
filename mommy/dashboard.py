...
def _home_embed() -> discord.Embed:
    return discord.Embed(
        ...
        description=(
            ...
            "Mommy.exe keeps her voice/staff systems here and also hosts a separate public member-games panel. Daddy's Belt keeps his own staff/admin side."
        ),
    )
...
class MommyDashboardView(discord.ui.View):
    ...
    @discord.ui.button(label="Publish Games Panel", emoji="🎮", style=discord.ButtonStyle.success, row=2)
    async def publish_games(self, interaction: discord.Interaction, button: discord.ui.Button) -> None:
        ...
        await interaction.response.send_message(
            "Publishing Mommy.exe's public games panel in this channel.",
            ephemeral=True,
        )
