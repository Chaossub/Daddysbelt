...
,
 ...
 'black_cards': [{'text': 'Greggy knew the gun was loaded because ____.', 'pick': 1},
                 ...
                 {'text': 'Jean announced he wanted to do 360s off a bridge because of ____.', 'pick': 1},
                 {'text': 'Nobody was prepared for what happened at the Greek yogurt factory grand opening: ____.', 'pick': 1},
                 {'text': 'Greggy is simultaneously a lesbian and the straightest person alive because of ____.', 'pick': 1},
                 {'text': 'The kangaroo fursuit incident somehow involved ____.', 'pick': 1},
                 {'text': 'The server really should have gone to therapy after ____.', 'pick': 1},
                 {'text': 'Nobody knows who started ____ and nobody wants to admit it.', 'pick': 1},
                 {'text': 'The group chat evidence folder now contains ____.', 'pick': 1},
                 {'text': 'Against all odds, the conversation became about ____.', 'pick': 1},
                 {'text': 'Greggy knew immediately because of ____.', 'pick': 1},
                 {'text': 'The server rated ____ entirely by mouth feel.', 'pick': 1}],
 'white_cards': ["Greggy's ass holster",
                 ...
                 'a concerning amount of experience with mouth feel',
                 'Evidence.',
                 'Probation.',
                 'Consequences.',
                 'Lore.']},
...
PACK_CATEGORIES: dict[str, tuple[str, str, list[str]]] = {
    ...
    "fandom": ("🎭 Fandom / Events", "Convention and fandom chaos.", [
        ...
        "builtin:jujutsu_kaisen", "builtin:he_man", "builtin:meta_knight", "builtin:trailer_park_boys",
