...
,
 'builtin:he_man': {'name': 'He-Man & Masters of the Universe',
                    'description': 'Eternia, questionable magic, screaming muscle men, and Skeletor being a professional hater.',
                    'black_cards': [
                        {'text': 'Skeletor’s latest plot to conquer Eternia involves ____.', 'pick': 1},
                        {'text': 'He-Man raised his sword and accidentally summoned ____.', 'pick': 1},
                        {'text': 'Castle Grayskull has officially banned ____ from the premises.', 'pick': 1},
                        {'text': 'Battle Cat refuses to leave the house without ____.', 'pick': 1},
                        {'text': 'Orko’s spell went wrong and turned the entire room into ____.', 'pick': 1},
                        {'text': 'Skeletor lost another fight because he was distracted by ____.', 'pick': 1},
                        {'text': 'The real secret of He-Man’s strength is ____.', 'pick': 1},
                        {'text': 'Man-At-Arms insists ____ is technically a weapon.', 'pick': 1},
                        {'text': 'Teela walked into the throne room and immediately found ____.', 'pick': 1},
                        {'text': 'Eternia’s newest royal decree strictly prohibits ____.', 'pick': 1},
                        {'text': 'Skeletor entered Castle Grayskull carrying ____ and absolutely no plan.', 'pick': 1},
                        {'text': 'He-Man’s new training routine is just ____ followed by ____.', 'pick': 2},
                        {'text': 'The Sorceress says the prophecy specifically warned about ____.', 'pick': 1},
                        {'text': 'Cringer finally snapped after being exposed to ____.', 'pick': 1},
                        {'text': 'The Snake Men were defeated by something even worse: ____.', 'pick': 1},
                        {'text': 'Skeletor’s group chat leaked, revealing an unhealthy obsession with ____.', 'pick': 1},
                        {'text': 'The royal banquet was ruined when Orko produced ____.', 'pick': 1},
                        {'text': 'He-Man’s heroic entrance was immediately ruined by ____.', 'pick': 1},
                        {'text': 'Hordak crossed dimensions specifically to avoid ____.', 'pick': 1},
                        {'text': 'The most powerful artifact on Eternia is apparently ____.', 'pick': 1},
                        {'text': 'Skeletor screamed for ten straight minutes after discovering ____.', 'pick': 1},
                        {'text': 'Nobody warned He-Man that the transformation also came with ____.', 'pick': 1},
                        {'text': 'The next Masters meeting is dedicated entirely to discussing ____.', 'pick': 1},
                        {'text': 'Beast Man was asked to leave after bringing ____ into the castle.', 'pick': 1},
                        {'text': 'Evil-Lyn’s backup plan consists of ____ and plausible deniability.', 'pick': 1},
                        {'text': 'He-Man and Skeletor temporarily teamed up to stop ____.', 'pick': 1},
                        {'text': 'The gates of Castle Grayskull opened to reveal ____.', 'pick': 1},
                        {'text': 'Skeletor’s motivational speech somehow became a rant about ____.', 'pick': 1},
                        {'text': 'Eternia entered a state of emergency after someone unleashed ____.', 'pick': 1},
                        {'text': 'The true battle for Eternia will ultimately be decided by ____ versus ____.', 'pick': 2},
                    ],
                    'white_cards': [
                        'Skeletor being a full-time hater',
                        'Skeletor dramatically pointing at nothing',
                        'Skeletor losing an argument to a chair',
                        'Skeletor calling a meeting just to complain',
                        'Skeletor plotting something that absolutely could have been an email',
                        'Skeletor rage-quitting Eternia',
                        'Skeletor practicing insults in the mirror',
                        'Skeletor having the emotional regulation of a smoke alarm',
                        'Skeletor showing up uninvited with a monologue',
                        'Skeletor blaming He-Man for his Wi-Fi',
                        'Skeletor.',
                        'Bonehead behavior.',
                        'He-Man flexing during a completely unrelated conversation',
                        'He-Man solving diplomacy with biceps',
                        'He-Man treating every doorway like a dramatic entrance',
                        'He-Man forgetting he has an indoor voice',
                        'He-Man using a sword for something wildly unnecessary',
                        'He-Man.',
                        'Biceps.',
                        'Battle Cat demanding hazard pay',
                        'Battle Cat judging everyone in the room',
                        'Battle Cat refusing to participate in this nonsense',
                        'Battle Cat.',
                        'Cringer having a completely reasonable panic attack',
                        'Cringer.',
                        'Orko casting the wrong spell again',
                        'Orko accidentally summoning a tax auditor',
                        'Orko turning dinner into an active crime scene',
                        'Orko.',
                        'Teela carrying the entire team emotionally',
                        'Teela discovering another preventable disaster',
                        'Teela.',
                        'Man-At-Arms building something OSHA would hate',
                        'Man-At-Arms weaponizing a household appliance',
                        'Man-At-Arms.',
                        'Evil-Lyn being the only competent villain in the room',
                        'Evil-Lyn.',
                        'Beast Man smelling like wet carpet and regret',
                        'Beast Man.',
                        'Hordak arriving with divorced-dad energy',
                        'Hordak.',
                        'Castle Grayskull with a landlord special',
                        'Castle Grayskull.',
                        'a cursed Eternian group chat',
                        'an enchanted loincloth',
                        'a sword with absolutely no child lock',
                        'an avoidable magical incident',
                        'a suspicious amount of body oil',
                        'a throne room HR complaint',
                        'a dramatic cape caught in a door',
                        'an ancient prophecy written like a vague Facebook post',
                        'a royal family meeting that should have been therapy',
                        'a magic portal opening directly into a bathroom',
                        'a cursed weapon from Temu',
                        'a heroic amount of property damage',
                        'a completely unnecessary transformation sequence',
                        'an Eternian restraining order',
                        'a villain lair with terrible acoustics',
                        'a screaming skull with management experience',
                        'Eternia.',
                    ]}

,
 'builtin:meta_knight': {'name': 'Meta Knight',
                        'description': 'Masked swordsman drama, Dream Land nonsense, and Meta Knight taking everything way too seriously.',
                        'black_cards': [
                            {'text': 'Meta Knight challenged Kirby to a duel over ____.', 'pick': 1},
                            {'text': 'The Halberd was grounded after somebody loaded it with ____.', 'pick': 1},
                            {'text': 'Meta Knight removed his mask and revealed ____.', 'pick': 1},
                            {'text': 'Kirby defeated Meta Knight using nothing but ____.', 'pick': 1},
                            {'text': 'The Meta-Knights staged a mutiny over ____.', 'pick': 1},
                            {'text': 'King Dedede declared ____ a national emergency.', 'pick': 1},
                            {'text': 'Meta Knight’s training regimen consists of ____ and ____.', 'pick': 2},
                            {'text': 'Dream Land’s newest law specifically bans ____.', 'pick': 1},
                            {'text': 'Meta Knight’s cape turned into wings at the worst possible moment: ____.', 'pick': 1},
                            {'text': 'The true purpose of Galaxia is apparently ____.', 'pick': 1},
                            {'text': 'Meta Knight spoke three words and somehow caused ____.', 'pick': 1},
                            {'text': 'The Halberd crashed because of ____. Again.', 'pick': 1},
                            {'text': 'Meta Knight insists ____ is essential to honor.', 'pick': 1},
                            {'text': 'Kirby swallowed ____ and immediately became everyone’s problem.', 'pick': 1},
                            {'text': 'The duel was canceled after Meta Knight saw ____.', 'pick': 1},
                            {'text': 'Bandana Waddle Dee walked in carrying ____.', 'pick': 1},
                            {'text': 'Meta Knight’s secret hobby is ____.', 'pick': 1},
                            {'text': 'The latest threat to Dream Land is somehow ____.', 'pick': 1},
                            {'text': 'King Dedede blamed Meta Knight for ____ and honestly he might be right.', 'pick': 1},
                            {'text': 'Meta Knight’s dramatic entrance was ruined by ____.', 'pick': 1},
                            {'text': 'The most honorable way to solve this is apparently ____.', 'pick': 1},
                            {'text': 'Meta Knight banned Kirby from the Halberd after ____.', 'pick': 1},
                            {'text': 'The crew found ____ hidden under Meta Knight’s cape.', 'pick': 1},
                            {'text': 'Galacta Knight was summoned to deal with ____.', 'pick': 1},
                            {'text': 'Meta Knight stared silently at ____ for six full minutes.', 'pick': 1},
                            {'text': 'The final boss music started when someone mentioned ____.', 'pick': 1},
                            {'text': 'Meta Knight’s idea of team bonding is ____ followed by ____.', 'pick': 2},
                            {'text': 'The Halberd cafeteria had to stop serving ____.', 'pick': 1},
                            {'text': 'Dream Land was saved by the unexpected power of ____.', 'pick': 1},
                            {'text': 'Meta Knight’s mask cracked after exposure to ____.', 'pick': 1},
                        ],
                        'white_cards': [
                            'Meta Knight brooding in the corner',
                            'Meta Knight taking a minor disagreement as a duel challenge',
                            'Meta Knight refusing to explain anything',
                            'Meta Knight polishing Galaxia for emotional support',
                            'Meta Knight pretending the Halberd crash was intentional',
                            'Meta Knight disappearing mid-conversation',
                            'Meta Knight making eye contact through the mask somehow',
                            'Meta Knight treating lunch like a military briefing',
                            'Meta Knight insisting this is about honor',
                            'Meta Knight being five inches tall and furious',
                            'Meta Knight.',
                            'Galaxia.',
                            'The Halberd.',
                            'Kirby inhaling the evidence',
                            'Kirby eating something load-bearing',
                            'Kirby solving the conflict with snacks',
                            'Kirby.',
                            'King Dedede making it everyone else’s problem',
                            'King Dedede with a hammer and no supervision',
                            'King Dedede.',
                            'Bandana Waddle Dee carrying the team again',
                            'Bandana Waddle Dee.',
                            'a tiny masked war criminal with excellent posture',
                            'a sword fight nobody asked for',
                            'a suspiciously dramatic cape',
                            'a spaceship held together by ego',
                            'a duel at 3 AM',
                            'a completely unnecessary boss battle',
                            'an honor code nobody else agreed to',
                            'a snack-induced diplomatic crisis',
                            'a warp star in a no-parking zone',
                            'a Waddle Dee union meeting',
                            'a boss theme playing from nowhere',
                            'a mask crack at the worst possible time',
                            'a very small knight with very large feelings',
                            'Dream Land OSHA',
                            'orb-shaped violence',
                            'a cape full of unresolved issues',
                            'a dramatic pause that lasted too long',
                            'an emergency Maxim Tomato',
                            'a cursed copy ability',
                            'a dimensional rift behind the vending machine',
                            'a sword bigger than the person holding it',
                            'an airship insurance claim',
                            'a suspicious amount of blueberries',
                            'a nap powerful enough to stop the plot',
                            'a final boss nobody invited',
                            'a secret identity everyone already knows',
                            'a knightly restraining order',
                            'a tactical snack break',
                            'Honor.',
                            'Brooding.',
                            'Kirby.',
                            'Dedede.',
 ...
 'builtin:server_evidence': {'name': 'Femboy Hooters Evidence Folder',
 'description': 'Weaponized server lore, Fortnite crimes, missing consonants, stolen wives, and evidence that should '
                'never see daylight.',
 'black_cards': [{'text': 'Greggy knew the gun was loaded because ____.', 'pick': 1},
                 {'text': 'Nobody questioned Greggy putting ____ in his ass until it was already server lore.',
                  'pick': 1},
                 {'text': "Greggy's firearm safety course consists of ____ followed by ____.", 'pick': 2},
                 {'text': 'The VC went completely silent after Greggy announced ____.', 'pick': 1},
                 {'text': 'Another sentence beginning with “Greggy said…” ended with ____.', 'pick': 1},
                 {'text': 'Greggy tested the automod by saying an absolutely unreasonable amount of ____.', 'pick': 1},
                 {'text': 'Bot testing immediately went off the rails when Greggy started ____.', 'pick': 1},
                 {'text': 'Greggy insisted it was “for testing purposes” after ____.', 'pick': 1},
                 {'text': 'The automod stress test became significantly less scientific after Greggy ____.', 'pick': 1},
                 {'text': 'Lucian was given five unsupervised minutes and immediately said ____.', 'pick': 1},
                 {'text': "Juliette and Lucian's latest argument started over ____.", 'pick': 1},
                 {'text': 'Lucian tried to defend his vocabulary by saying ____.', 'pick': 1},
                 {'text': 'The server created another rule specifically because of ____.', 'pick': 1},
                 {'text': 'Jean carried the entire Fortnite squad while everyone else was busy with ____.', 'pick': 1},
                 {'text': "Jean's newest waifu would probably leave him over ____.", 'pick': 1},
                 {'text': 'Jean finally admitted the furry allegations were true after ____.', 'pick': 1},
                 {'text': 'Jean turned 30 and Juliette immediately told him to start digging ____.', 'pick': 1},
                 {'text': 'Jean complained about being 30, so the server prepared ____ for his rapidly approaching '
                          'expiration date.',
                  'pick': 1},
                 {'text': 'Juliette and Ami formed the cripple squad to accomplish ____.', 'pick': 1},
                 {'text': 'Juliette and Ami may be crippled, but at least they can still ____.', 'pick': 1},
                 {'text': 'The server treats anyone over 30 like they need ____ immediately.', 'pick': 1},
                 {'text': 'Anyone over 30 is apparently already on hospice because the server is dramatic about ____.',
                  'pick': 1},
                 {'text': 'Jean turned 30 and the server immediately scheduled ____ for his final days.', 'pick': 1},
                 {'text': 'Christian yelled about the gnomes after they ____.', 'pick': 1},
                 {'text': "Christian's latest completely contextless response to getting jumped in-game was ____.",
                  'pick': 1},
                 {'text': 'The gnomes showed up again and Christian immediately screamed ____.', 'pick': 1},
                 {'text': 'Nobody knows what “gnut” means, but Christian says it whenever ____.', 'pick': 1},
                 {'text': 'Christian said “nut” with such conviction that ____ happened.', 'pick': 1},
                 {'text': 'The server heard “rape gnomes” and collectively decided ____.', 'pick': 1},
                 {'text': 'Jean was told to dig his own grave because ____.', 'pick': 1},
                 {'text': 'The furry convention was going fine until Jean brought ____.', 'pick': 1},
                 {'text': 'Nobody expected the phrase “sensual deep throating” to be followed by ____.', 'pick': 1},
                 {'text': 'Jean could have revived the squad, but he was distracted by ____.', 'pick': 1},
                 {'text': "Christian's Skeletor impression became significantly more cursed after ____.", 'pick': 1},
                 {'text': 'Nobody: absolutely nobody: Christian, in the Skeletor voice: “____.”', 'pick': 1},
                 {'text': "Christian said “I swear if you're around this corner I'm gonna ____.”", 'pick': 1},
                 {'text': 'Nobody knew what Christian was threatening until he yelled ____.', 'pick': 1},
                 {'text': 'Christian entered VC and immediately said something involving ____.', 'pick': 1},
                 {'text': 'The server stopped asking Christian to elaborate after ____.', 'pick': 1},
                 {'text': 'Another completely normal sentence from Christian: ____.', 'pick': 1},
                 {'text': 'Juliette has once again begun explaining how she plans to get her boyfriend pregnant using '
                          '____.',
                  'pick': 1},
                 {'text': "Juliette's boyfriend received the deeply concerning news that ____.", 'pick': 1},
                 {'text': 'Phong was banned from the potluck after ____.', 'pick': 1},
                 {'text': 'Nobody got worried until Phong asked whether ____ was still fresh.', 'pick': 1},
                 {'text': 'Phong looked at the VC and saw ____ instead of friends.', 'pick': 1},
                 {'text': "It has been way too long and Jame still hasn't noticed ____.", 'pick': 1},
                 {'text': 'Juliette quietly stole ____ from Jame and waited to see how long it would take.', 'pick': 1},
                 {'text': 'Jame finally noticed something was wrong when ____.', 'pick': 1},
                 {'text': 'The phrase “Ami, NO” is usually followed by ____.', 'pick': 1},
                 {'text': 'Nobody invites Ami to the baby shower anymore because of ____.', 'pick': 1},
                 {'text': "Granny Ami's finishing move is ____.", 'pick': 1},
                 {'text': 'Ami earned the title “Granny” because ____.', 'pick': 1},
                 {'text': 'Being the oldest person in the server means Ami is automatically responsible for ____.',
                  'pick': 1},
                 {'text': "Juliette's road rage reached critical levels after someone ____.", 'pick': 1},
                 {'text': 'Juliette saw one bad driver and immediately threatened ____.', 'pick': 1},
                 {'text': 'The passenger seat went silent when Juliette started yelling about ____.', 'pick': 1},
                 {'text': "Juliette's commute became a boss fight because of ____.", 'pick': 1},
                 {'text': 'Kage saw a foot and immediately demanded ____.', 'pick': 1},
                 {'text': "The fastest way to ruin Kage's day is to show him ____.", 'pick': 1},
                 {'text': 'Juliette told Christian to start selling feet pics after ____.', 'pick': 1},
                 {'text': 'Christian considered monetizing ____ after Juliette said “sell the feet pics.”', 'pick': 1},
                 {'text': "Christian yelled “don't tase me, I'll ____!” and somehow made the situation worse.",
                  'pick': 1},
                 {'text': 'Nobody was prepared for Christian to respond to a taser threat with ____.', 'pick': 1},
                 {'text': "Juliette's preferred zombie-killing technique in 7 Days to Die is apparently ____.",
                  'pick': 1},
                 {'text': 'The zombie never expected Juliette to come at it with ____.', 'pick': 1},
                 {'text': '7 Days to Die became significantly less survival-horror after Juliette started ____.',
                  'pick': 1},
                 {'text': "Christian's newest survival strategy is yelling ____ before anyone can react.", 'pick': 1},
                 {'text': 'Christos knew the Crispy Toes nickname had gone too far when ____.', 'pick': 1},
                 {'text': 'Nobody has called Christos by his government name since ____.', 'pick': 1},
                 {'text': 'Crispy Toes entered VC and immediately announced ____.', 'pick': 1},
                 {'text': 'Christos consumed the Cum Chalice and immediately unlocked ____.', 'pick': 1},
                 {'text': 'Nobody expected the Cum Chalice to be followed by ____.', 'pick': 1},
                 {'text': 'The server opened Twitter and immediately tried to cancel someone over ____.', 'pick': 1},
                 {'text': 'Another completely normal day in the server: open Twitter, then cancel ____.', 'pick': 1},
                 {'text': 'The server decided ____ was officially over after one Twitter thread.', 'pick': 1},
                 {'text': 'The server went completely off-topic after somebody mentioned ____.', 'pick': 1},
                 {'text': 'The bush sprite pulled up and everyone immediately said ____.', 'pick': 1},
                 {'text': 'Playing as the bush sprite turned into twenty straight minutes of yelling about ____.',
                  'pick': 1},
                 {'text': 'Someone spotted the bush sprite and immediately said “____.”', 'pick': 1},
                 {'text': "Grizz's defense for stealing Juliette's wife was simply ____.", 'pick': 1},
                 {'text': 'The latest Femboy Hooters custody dispute involves Juliette, Grizz, and ____.', 'pick': 1},
                 {'text': 'Juliette finally got her wife back after bribing Grizz with ____.', 'pick': 1},
                 {'text': 'Nothing strikes fear into a Fortnite lobby like ____.', 'pick': 1},
                 {'text': 'The Brina Squad pulled up wearing ____.', 'pick': 1},
                 {'text': "The Brina Squad's battle strategy is mostly ____ and matching Sabrina skins.", 'pick': 1},
                 {'text': 'The Fortnite lesbians pulled up as Harley Quinn, Catwoman, and Poison Ivy to ____.',
                  'pick': 1},
                 {'text': 'Greggy became Harley Quinn and immediately started ____.', 'pick': 1},
                 {'text': 'Jean picked Catwoman because of ____.', 'pick': 1},
                 {'text': 'Juliette chose Poison Ivy and the lobby instantly became ____.', 'pick': 1},
                 {'text': 'The Fortnite lesbians stopped playing Fortnite and started ____.', 'pick': 1},
                 {'text': 'Nobody was prepared for the Spidussy to ____.', 'pick': 1},
                 {'text': 'The real reason the multiverse collapsed was ____.', 'pick': 1},
                 {'text': 'The Rebaconator returned, somehow carrying ____.', 'pick': 1},
                 {'text': 'Nobody knew what the Rebaconator actually was until ____.', 'pick': 1},
                 {'text': 'Tonight on Femboy Hooters Court: Greggy is accused of ____.', 'pick': 1},
                 {'text': 'Femboy Hooters HR received simultaneous complaints involving ____ and ____.', 'pick': 2},
                 {'text': 'Juliette opened the evidence folder and immediately found ____ next to ____.', 'pick': 2},
                 {'text': 'The official Femboy Hooters starter pack includes ____ and ____.', 'pick': 2},
                 {'text': "Tonight's VC agenda: ____ followed immediately by ____.", 'pick': 2},
                 {'text': 'The server survived another night despite ____.', 'pick': 1},
                 {'text': 'The moderators opened the logs and discovered ____.', 'pick': 1},
                 {'text': 'Jean announced he was going to do 360s off a bridge because of ____.', 'pick': 1},
                 {'text': 'The Greek yogurt factory grand opening was ruined by ____.', 'pick': 1},
                 {'text': 'Greggy is somehow both a lesbian and ____ at the same time.', 'pick': 1},
                 {'text': 'Greggy being the straightest person alive was immediately contradicted by ____.', 'pick': 1},
                 {'text': 'The kangaroo fursuit became a problem when someone added ____.', 'pick': 1},
                 {'text': 'Nobody was prepared for the conversation to suddenly become about foreskin and ____.',
                  'pick': 1},
                 {'text': 'The entire VC spiraled into everyone talking about killing themselves because of ____.',
                  'pick': 1},
                 {'text': 'The piss bucket was discovered next to ____.', 'pick': 1},
                 {'text': 'The piss drawer somehow contained ____ and nobody asked questions.', 'pick': 1},
                 {'text': 'The cum jar became evidence after ____.', 'pick': 1},
                 {'text': 'Rating “it” by mouth feel revealed ____.', 'pick': 1},
                 {'text': 'Identifying “it” by mouth feel alone should never have involved ____.', 'pick': 1},
                 {'text': 'The unmistakable mouth feel of ____ ended the argument instantly.', 'pick': 1},
                 {'text': 'Having a concerning amount of experience with mouth feel finally paid off when ____.',
                  'pick': 1},
                 {'text': 'The server opened Twitter and collectively decided to cancel ____.', 'pick': 1},
                 {'text': 'Everyone joined the cancellation thread after someone posted ____.', 'pick': 1},
                 {'text': 'The server somehow turned a normal conversation into a discussion about pegging and ____.',
                  'pick': 1},
                 {'text': 'Nobody expected pegging to become relevant to ____.', 'pick': 1},
                 {'text': "Tonight's completely normal VC topic is pegging followed by ____.", 'pick': 1},
                 {'text': 'The group chat became significantly less safe for work after someone mentioned ____ and '
                          'pegging.',
                  'pick': 1}],
 'white_cards': ["Greggy's ass holster",
                 'Greggy determining chamber status by mouth feel',
                 'Greggy explaining gun safety with terrifying confidence',
                 'a firearm stored somewhere God never intended',
                 'a gun where a gun should absolutely not be',
                 'Greggy.',
                 'Greggy saying an excessive amount of slurs to test the automod',
                 'Greggy turning bot testing into a vocabulary stress test',
                 '“It was for automod testing.”',
                 'an irresponsible amount of test slurs',
                 'Greggy stress-testing every filter at once',
                 'Mouthfeel.',
                 'Assgun.',
                 'Lucian discovering another word he absolutely cannot say',
                 'Lucian testing the limits of the vocabulary policy',
                 'Lucian beginning a sentence with “technically…”',
                 "Lucian's vocabulary probation",
                 'another Juliette vs. Lucian slur hearing',
                 "Juliette confiscating Lucian's vocabulary",
                 'Juliette beefing with Lucian again',
                 'a slur-related disciplinary hearing',
                 "Jean's emergency waifu folder",
                 'Jean carrying four useless people through Fortnite',
                 'Jean clutching a 1v4 while everyone screams',
                 'Jean ignoring reality for an anime woman',
                 "Jean's suspiciously organized waifu ranking",
                 'Jean being a furry',
                 'the furry allegations',
                 'an aggressively expensive fursuit',
                 'a suspicious amount of yiff-adjacent energy',
                 'Jean entering his furry era',
                 'Jean turning 30 and immediately expiring',
                 'telling Jean to start digging his grave',
                 'Jean complaining about being ancient at 30',
                 'Jean receiving his senior discount early',
                 'the server treating 30 like a terminal diagnosis',
                 'Juliette and Ami, the cripple squad',
                 'Juliette and Ami comparing mobility problems',
                 'two crippled bitches with a plan',
                 'hating old people recreationally',
                 'the entire server acting like 30 means hospice',
                 'acting like anyone over 30 is already on hospice',
                 'Jean receiving end-of-life care at 30',
                 'a hospice bracelet for turning 30',
                 'Christian yelling about gnomes',
                 'the gnomes',
                 'Gnomes.',
                 'rape gnomes',
                 'Christian getting jumped by gnomes in a game',
                 'Christian saying “nut” for absolutely no reason',
                 'Nut.',
                 'gnut',
                 'Gnut.',
                 'Christian inventing another cursed word on the spot',
                 'Sensual deep throating.',
                 'a completely unsolicited lesson in sensual deep throating',
                 'Waifus.',
                 'Fortnite.',
                 "Christian becoming Skeletor against everyone's will",
                 'Christian doing the Skeletor voice during a serious conversation',
                 'Christian refusing to break character',
                 'Christian saying absolutely insane shit with no warning',
                 'Christian threatening his own pubes around a blind corner',
                 '“I swear if you’re around this corner I’m gonna rip off my pubes.”',
                 'Christian turning a normal threat into a genital emergency',
                 'another sentence only Christian could possibly say',
                 'Christian with zero context and even less restraint',
                 'Skeletor joining VC',
                 '“NYEH, HE-MAN!”',
                 'a suspicious Skeletor impression',
                 'Juliette trying to impregnate a man through sheer determination',
                 'Juliette explaining male pregnancy logistics again',
                 "Juliette's boyfriend receiving extremely concerning news",
                 'an anatomically ambitious pregnancy plan',
                 'Pregnant boyfriend.',
                 'Phong entering his cannibal era',
                 'Phong asking if anyone is gonna finish that',
                 'Phong looking at the VC like a charcuterie board',
                 'Phong bringing his own seasoning',
                 '“Phong, put the fork down.”',
                 'friendship, but apparently edible',
                 'Phong.',
                 'Cannibalism.',
                 'Jame still looking for his S',
                 "the missing S from Jame's name",
                 'Jame somehow not noticing',
                 'James becoming Jame against his will',
                 'one stolen consonant',
                 '“Has anyone told Jame yet?”',
                 'Jame.',
                 'Ami, the baby-kicking granny',
                 'Granny Ami choosing violence',
                 'Ami winding up the orthopedic shoe',
                 '“Not the baby, Ami.”',
                 'a surprisingly aerodynamic infant',
                 'senior citizen hostility',
                 'Ami getting banned from another daycare',
                 'Ami.',
                 'Granny Ami because she is the oldest',
                 'Ami receiving senior-citizen status by server decree',
                 'the server calling the oldest person Granny',
                 'everyone over 30 being placed on hospice',
                 'a completely unnecessary hospice referral',
                 'turning 30 and immediately being declared medically ancient',
                 "Juliette's road rage",
                 'Juliette verbally fighting another driver through a windshield',
                 'Juliette treating a bad merge like a personal attack',
                 'Juliette entering vehicular boss-battle mode',
                 'someone driving five under in front of Juliette',
                 'a turn signal apparently being optional',
                 'Kage hating feet with his entire soul',
                 'Kage being personally offended by toes',
                 "a foot appearing in Kage's field of vision",
                 'Kage declaring war on feet',
                 'Juliette telling Christian to sell feet pics',
                 'Christian monetizing the toes',
                 'an unsolicited feet-pic business plan',
                 'Christian opening an OnlyFeet account',
                 "“Don't tase me, I'll nut.”",
                 'Christian threatening to nut if tased',
                 'a taser-induced nut emergency',
                 'Juliette fisting zombies in 7 Days to Die',
                 'zombie fisting as a survival strategy',
                 'Juliette choosing fists over firearms',
                 'an undead creature learning a deeply personal lesson',
                 'Christian making the taser situation sexually confusing',
                 'Crispy Toes',
                 'Christos losing custody of his actual name',
                 'a suspiciously crunchy foot',
                 'Christos answering to Crispy Toes without hesitation',
                 'toe-related defamation',
                 "“That's not even his fucking name.”",
                 'Crispy.',
                 'Toes.',
                 'Christos consuming the Cum Chalice',
                 'the Cum Chalice',
                 'an inadvisable ceremonial gulp',
                 'everyone canceling people on Twitter',
                 'a 47-post server cancellation thread',
                 'the server declaring someone “over”',
                 'getting ratioed by the entire server',
                 'a Twitter cancellation nobody asked for',
                 'a good bush sprite',
                 'the bush sprite looking suspiciously good',
                 'everyone yelling about the bush sprite',
                 'rating the bush sprite like it is a beauty pageant',
                 'the bush sprite causing unnecessary discourse',
                 'Bush sprite.',
                 '“Nice bush.”',
                 'playing as the bush sprite',
                 'the entire squad admiring the same bush',
                 '“That is a NICE bush.”',
                 "Grizz stealing Juliette's wife",
                 'Juliette filing for emergency wife custody',
                 'Grizz saying “our wife”',
                 "shared custody of Juliette's wife",
                 'matrimonial grand larceny',
                 'wife repossession',
                 '“Grizz, give her back.”',
                 'one suspiciously stolen spouse',
                 'The Rebaconator',
                 'the Brina Squad',
                 'five Sabrinas rushing one guy',
                 'an unnecessary amount of Sabrina Carpenter',
                 'matching Sabrina skins',
                 'Sabrina Carpenter tactical operations',
                 'a synchronized Sabrina ambush',
                 'getting eliminated by the Brina Squad',
                 'Sabrina Carpenter with a shotgun',
                 'the Brina Squad entering like a girl group',
                 'too many Sabrinas in one POI',
                 'Fortnite lesbians',
                 'cosplaying as lesbians in Fortnite',
                 'Greggy as Harley Quinn',
                 'Jean as Catwoman',
                 'Juliette as Poison Ivy',
                 'Harley Quinn, Catwoman, and Poison Ivy committing squad crimes',
                 'Greggy in full Harley Quinn mode',
                 'Jean as Catwoman for lesbian reasons',
                 'Juliette as Poison Ivy causing plant-based problems',
                 'the DC lesbian strike team',
                 'three lesbians and a Victory Crown',
                 'matching skins and zero shame',
                 'Spidussy',
                 'the Spidussy',
                 'friendly neighborhood Spidussy',
                 'forbidden Spider-Man anatomy',
                 'getting distracted by the Spidussy',
                 'web-slinging cheeks',
                 'radioactive ass',
                 '“Not the Spidussy.”',
                 'a webbed-up bad decision',
                 'server lore nobody is allowed to explain to newcomers',
                 '“You had to be there.”',
                 "the server's collective loss of innocence",
                 'screenshots that should have stayed buried',
                 'a mod log that reads like a police report',
                 'six people yelling over each other in VC',
                 'somebody saying “clip that”',
                 'evidence.mp4',
                 '“This is going in server lore.”',
                 'a conversation that permanently changed the rules',
                 'plausible deniability',
                 'the owner logging on at the worst possible moment',
                 'an HR department we very obviously do not have',
                 'the VC equivalent of a crime scene',
                 'a deeply unnecessary custody hearing',
                 'another absolutely preventable incident',
                 'Evidence.',
                 'Probation.',
                 'Consequences.',
                 'Lore.',
                 'Jean wanting to do 360s off a bridge',
                 'the Greek yogurt factory grand opening',
                 'Greggy being a lesbian',
                 'Greggy being the straightest person alive',
                 'a kangaroo fursuit',
                 'foreskin',
                 'all of us talking about killing ourselves',
                 'the piss bucket',
                 'the piss drawer',
                 'the cum jar',
                 'rating “it” by mouth feel',
                 'identifying “it” by mouth feel alone',
                 'the unmistakable mouth feel',
                 'having a concerning amount of experience with mouth feel',
                 'an unsettlingly confident mouth-feel assessment',
                 'everyone canceling people on Twitter',
                 'the whole server joining a Twitter cancellation thread',
                 'a coordinated cancellation effort',
                 'pegging',
                 'an unnecessary amount of pegging discourse',
                 'bringing up pegging with absolutely no warning',
                 'a deeply committed pegging agenda',
                 'Pegging.']},
 'builtin:trailer_park_boys': {'name': 'Trailer Park Boys',
 'description': 'Sunnyvale schemes, kitties, cheeseburgers, liquor, and catastrophically bad decisions.',
 'black_cards': [{'text': "Ricky's newest get-rich-quick scheme involves ____.", 'pick': 1},
                 {'text': 'Julian refused to put down his drink even while ____.', 'pick': 1},
                 {'text': 'Bubbles opened the shed and discovered ____.', 'pick': 1},
                 {'text': 'Lahey is absolutely convinced that ____ is part of the shit winds.', 'pick': 1},
                 {'text': 'Randy took off his shirt because of ____.', 'pick': 1},
                 {'text': 'The boys are going back to jail because of ____.', 'pick': 1},
                 {'text': 'Ricky tried to explain ____ and somehow made it less understandable.', 'pick': 1},
                 {'text': 'The latest Sunnyvale business venture is just ____ with extra steps.', 'pick': 1},
                 {'text': 'Bubbles would risk everything for ____.', 'pick': 1},
                 {'text': "Julian's plan was flawless until ____ showed up.", 'pick': 1},
                 {'text': "Lahey's liquor-fueled prophecy warned everyone about ____.", 'pick': 1},
                 {'text': "Randy's cheeseburger budget was destroyed by ____.", 'pick': 1},
                 {'text': 'The cops arrived at Sunnyvale and immediately found ____.', 'pick': 1},
                 {'text': "Ricky's parenting advice is mostly ____ and ____.", 'pick': 2},
                 {'text': 'The real reason the trailer park is always broke is ____.', 'pick': 1},
                 {'text': "Bubbles' latest kitty emergency involves ____.", 'pick': 1},
                 {'text': 'Julian called a trailer park meeting to discuss ____.', 'pick': 1},
                 {'text': 'Lahey stumbled into the yard yelling about ____.', 'pick': 1},
                 {'text': 'Ricky accidentally turned ____ into evidence.', 'pick': 1},
                 {'text': 'Randy traded his last cheeseburger for ____.', 'pick': 1},
                 {'text': "The boys' foolproof plan requires ____ and absolutely no witnesses.", 'pick': 1},
                 {'text': "Sunnyvale's newest rule specifically bans ____.", 'pick': 1},
                 {'text': 'Bubbles put on the glasses and immediately realized ____.', 'pick': 1},
                 {'text': "Ricky's latest Rickyism somehow compares ____ to ____.", 'pick': 2},
                 {'text': "Julian's drink survived ____ but not ____.", 'pick': 2},
                 {'text': 'Lahey believes the shit hawks are circling because of ____.', 'pick': 1},
                 {'text': "Randy's pants disappeared immediately after ____.", 'pick': 1},
                 {'text': 'The bottle kids have upgraded from bottles to ____.', 'pick': 1},
                 {'text': 'The boys successfully made money for six minutes before ____.', 'pick': 1},
                 {'text': 'Tonight on Sunnyvale Court: Ricky is accused of ____.', 'pick': 1}],
 'white_cards': ["Ricky's completely foolproof business plan",
                 'Julian holding a rum and Coke through the apocalypse',
                 'Bubbles and seventeen cats',
                 'Lahey becoming one with the liquor',
                 'Randy without a shirt',
                 'Randy with another cheeseburger',
                 'the shit winds',
                 'the shit hawks',
                 'a trailer park felony',
                 'another avoidable jail sentence',
                 'a shopping cart worth twelve dollars',
                 "Bubbles' kitty empire",
                 'Ricky explaining basic science incorrectly',
                 'a deeply confident Rickyism',
                 "Julian's emergency drink",
                 'a cheeseburger picnic',
                 'Lahey whispering about shit',
                 "Randy's pants mysteriously vanishing",
                 'the bottle kids',
                 'a stolen barbecue',
                 'a driveway business with no paperwork',
                 'a bag of weed hidden somewhere stupid',
                 'a police chase at walking speed',
                 'a completely legitimate Sunnyvale enterprise',
                 'another terrible scheme from Ricky',
                 'Julian staring silently while everything collapses',
                 'Bubbles trying to be the only adult in the room',
                 'a shed full of cats',
                 'an extremely suspicious shopping cart',
                 'a trailer held together by duct tape and optimism',
                 'the same gun somehow becoming evidence again',
                 'a liquor-powered investigation',
                 'a cheeseburger emergency',
                 'Ricky blaming basic literacy',
                 'a business plan written on a cigarette pack',
                 'a lawn full of stolen property',
                 'Bubbles screaming about his kitties',
                 'Julian somehow never spilling his drink',
                 'Lahey announcing the arrival of the shit storm',
                 'Randy weaponizing a cheeseburger',
                 'Sunnyvale.',
                 'Ricky.',
                 'Julian.',
                 'Bubbles.',
                 ...
                 'Jail.',
                 'Shitwinds.',
                 'a greasy trailer park operation',
                 'a plan with absolutely no legal component',
                 'three grown men arguing beside a shopping cart',
                 'an amount of liquor that should require a permit',
                 'a cat with better judgment than everyone else',
                 'a minor inconvenience becoming a felony',
                 'a shirtless cheeseburger philosopher',
                 'the boys learning absolutely nothing',
                 'another peaceful day at Sunnyvale']},
 'builtin:red_dead_redemption': {'name': 'Red Dead Redemption',
 'description': "Cowboy GTA, Dutch's plans, terrible robberies, horse crimes, and enough honor loss to ruin a save "
                'file.',
 'black_cards': [{'text': 'Red Dead Redemption is basically Cowboy GTA, except with ____.', 'pick': 1},
                 {'text': 'Arthur Morgan took one look at ____ and said “I have a plan.”', 'pick': 1},
                 {'text': "Dutch's newest plan somehow requires ____ and ____.", 'pick': 2},
                 {'text': 'The Van der Linde gang got run out of town because of ____.', 'pick': 1},
                 {'text': "Arthur's journal has an entire page dedicated to ____.", 'pick': 1},
                 {'text': 'Micah ruined everything again by bringing ____.', 'pick': 1},
                 {'text': 'John Marston survived all of that just to deal with ____.', 'pick': 1},
                 {'text': 'Sadie Adler woke up and chose ____.', 'pick': 1},
                 {'text': "The gang's camp contribution box contains mostly ____.", 'pick': 1},
                 {'text': 'Dutch insists Tahiti will solve ____.', 'pick': 1},
                 {'text': 'Horse bonding level 4 was achieved through ____.', 'pick': 1},
                 {'text': 'Arthur lost honor after accidentally ____.', 'pick': 1},
                 {'text': 'The Pinkertons finally caught the gang because of ____.', 'pick': 1},
                 {'text': 'The saloon went quiet when Arthur walked in carrying ____.', 'pick': 1},
                 {'text': 'Cowboy GTA got significantly worse after someone added ____.', 'pick': 1},
                 {'text': 'The real final boss of Red Dead Redemption is ____.', 'pick': 1},
                 {'text': 'Arthur coughed once and everyone immediately blamed ____.', 'pick': 1},
                 {'text': "Dutch's plan would have worked if not for ____.", 'pick': 1},
                 {'text': "The gang's next robbery target is apparently ____.", 'pick': 1},
                 {'text': "John's ranching career ended abruptly because of ____.", 'pick': 1},
                 {'text': 'Arthur solved the problem the cowboy way: with ____.', 'pick': 1},
                 {'text': 'Sadie considers ____ a perfectly reasonable response.', 'pick': 1},
                 {'text': 'Someone tied ____ to the back of a horse and called it transportation.', 'pick': 1},
                 {'text': 'The honor system really should deduct points for ____.', 'pick': 1},
                 {'text': 'A random stranger in Saint Denis asked Arthur for ____.', 'pick': 1},
                 {'text': 'The campfire conversation took a turn after someone mentioned ____.', 'pick': 1},
                 {'text': 'The entire map became hostile because Arthur accidentally ____.', 'pick': 1},
                 {'text': 'The gang had money, faith, and absolutely no ____.', 'pick': 1},
                 {'text': 'The horse was fine until it encountered ____.', 'pick': 1},
                 {'text': 'Tonight on Cowboy GTA: Arthur attempts ____ while Dutch screams about ____.', 'pick': 2}],
 'white_cards': ['Cowboy GTA',
                 'Arthur Morgan',
                 'Dutch having another plan',
                 '“I have a plan.”',
                 'Tahiti.',
                 'Mangoes.',
                 'Micah being Micah',
                 'John Marston',
                 'Sadie Adler choosing violence',
                 'a horse with better survival instincts than the gang',
                 'max horse bonding',
                 'low honor behavior',
                 'high honor propaganda',
                 'getting kicked by your own horse',
                 'accidentally punching the wrong person in Saint Denis',
                 'a $300 bounty over something stupid',
                 'hogtying a stranger for no reason',
                 'putting a corpse on the back of a horse',
                 'Dutch explaining the plan for the fifteenth time',
                 'Arthur writing about it in his journal',
                 'camp chores nobody wants to do',
                 'the contribution box having $2.14 in it',
                 "Pearson's questionable stew",
                 'Uncle complaining about lumbago',
                 'Lumbago.',
                 'a train robbery with zero exit strategy',
                 'a saloon brawl that escalated instantly',
                 'one suspiciously calm cowboy',
                 'a deadeye-induced felony',
                 'a stranger mission that takes three business days',
                 'getting distracted by hunting for six hours',
                 'a perfect pelt ruined by one bad shot',
                 "a legendary animal ruining everyone's afternoon",
                 'the Pinkertons showing up at the worst possible time',
                 'a camp full of people who should not trust Dutch',
                 'Arthur coughing ominously',
                 'a cowboy existential crisis',
                 'a horse named something deeply inappropriate',
                 'falling off a cliff in cinematic mode',
                 'riding into a tree at full speed',
                 'accidentally drawing a gun in a shop',
                 'Saint Denis traffic',
                 'Valentine getting destroyed again',
                 'Blackwater being a terrible idea',
                 'a wagon robbery nobody planned correctly',
                 'a revolver with emotional significance',
                 'beans over a campfire',
                 'three dollars and a dream',
                 "the world's slowest escape plan",
                 'a cowboy doing tax evasion',
                 '“We just need more money.”',
                 '“Have some goddamn faith.”',
                 'the gang absolutely not going to Tahiti',
                 "Arthur being tired of everyone's shit",
                 'Micah making the situation worse',
                 'John somehow surviving',
                 'Sadie carrying the entire operation',
                 'Horse.',
                 'Bounty.',
                 'Honor.',
                 'Outlaw.']}
...
PACK_CATEGORIES: dict[str, tuple[str, str, list[str]]] = {
    ...
    "fandom": ("🎭 Fandom / Events", "Convention and fandom chaos.", [
        ...
        "builtin:jujutsu_kaisen", "builtin:he_man", "builtin:meta_knight", "builtin:trailer_park_boys", "builtin:red_dead_redemption",
        "builtin:youtube_gremlins",
    ]),
    "server": ("🍑 Server Lore", "Packs made for the server and its ongoing crimes.", [
        "builtin:femboy_hooters", "builtin:marcus_worm", "builtin:server_evidence",
    ]),
}
