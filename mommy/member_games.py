...
BUILTIN_PACKS: dict[str, dict[str, Any]] = {'builtin:chaos': {'name': 'House Chaos',
                   ...
                   'black_cards': [{'text': 'The group chat went silent after ____.', 'pick': 1},
                                   ...
                                   {'text': "Tonight's terrible idea is ____ followed immediately by ____.",
                                    'pick': 2},
                                   ...
                                   {'text': 'The apology would have worked if they had not mentioned ____.',
                                    'pick': 1},
                                   {'text': 'Step one: ____. Step two: ____. Step three: pretend this was '
                                            'intentional.',
                                    'pick': 2},
 ...
 'builtin:foul': {'name': 'Absolutely Foul',
                  'description': 'After-dark filth, bodily disasters, cursed hookups, and criminal group-chat '
                                 'energy.',
                  'black_cards': [{'text': 'The bathroom was permanently condemned after ____.', 'pick': 1},
                                  ...
                                  {'text': 'The group chat unanimously agreed never to discuss ____ again.',
                                   'pick': 1},
 ...
 'builtin:foul2': {'name': 'Unfit for Company',
                   ...
                   'black_cards': [{'text': 'The Airbnb host charged us $900 because of ____.', 'pick': 1},
                                   ...
                                   {'text': 'The date was going perfectly until ____ crawled out from under ____.',
                                    'pick': 2},
                                   {'text': 'There are some smells Febreze cannot defeat, especially ____.',
                                    'pick': 1},
                                   {'text': "The emergency room nurse took one look at ____ and whispered, 'Again?'",
                                    'pick': 1},
                                   {'text': "The hotel security footage will forever be known as 'the ____ "
                                            "incident.'",
                                    'pick': 1},
                                   ...
                                   {'text': 'The wedding registry included ____ and, for some reason, ____.',
                                    'pick': 2},
                                   {'text': 'The group vacation ended early because somebody packed ____.',
                                    'pick': 1},
                                   {'text': 'HR specifically asked me to stop bringing up ____ at lunch.', 'pick': 1},
                                   {'text': 'Nobody warned me that adulthood would involve this much ____.',
                                    'pick': 1},
 ...
 'builtin:digital_circus': {'name': 'The Amazing Digital Circus',
                            'description': 'Digital existential dread, Caine-approved nonsense, and absolutely '
                                           'normal circus activities.',
                            'black_cards': [{'text': "Caine's newest totally safe adventure involves ____.",
                                             'pick': 1},
                                            ...
                                            {'text': 'Kinger became unexpectedly lucid and warned us about ____.',
                                             'pick': 1},
                                            {'text': 'Ragatha is smiling through the emotional damage caused by '
                                                     '____.',
                                             'pick': 1},
                                            ...
                                            {'text': 'The exit door opened, but unfortunately it only led to ____.',
                                             'pick': 1},
                                            {'text': "Today's adventure has one rule: absolutely no ____.",
                                             'pick': 1},
                                            {'text': "Caine insists that ____ is 'great for morale.'", 'pick': 1},
                                            {'text': 'Nothing says digital immortality like ____ and ____.',
                                             'pick': 2},
                                            {'text': 'The circus gift shop is now selling ____ for 30,000 digital '
                                                     'tokens.',
                                             'pick': 1},
                                            {'text': 'Caine promises this adventure is only mildly traumatizing: '
                                                     '____.',
                                             'pick': 1},
                                            {'text': "Jax's newest hobby is replacing everyone's belongings with "
                                                     '____.',
                                             'pick': 1},
                                            ...
                                            {'text': "Zooble's missing piece was last seen attached to ____.",
                                             'pick': 1},
                                            {'text': 'Bubble has been banned from the kitchen after ____.',
                                             'pick': 1},
                                            {'text': 'Caine accidentally generated an NPC obsessed with ____.',
                                             'pick': 1},
                                            {'text': 'The circus talent show was cancelled because of ____.',
                                             'pick': 1},
                                            {'text': "Pomni's escape plan requires ____ and an unreasonable amount "
                                                     'of ____.',
                                             'pick': 2},
                                            {'text': "The next adventure is called 'Please Stop Screaming About "
                                                     "____.'",
                                             'pick': 1},
                                            {'text': "Jax insists ____ was 'just a prank.'", 'pick': 1},
                                            {'text': 'The void is now accepting applications for ____.', 'pick': 1},
                                            {'text': 'The circus finally found an exit, but Caine filled it with '
                                                     '____.',
                                             'pick': 1}],
 ...
 'builtin:youtube_gremlins': {'name': 'YouTube Gremlin Energy',
                              ...
                              'black_cards': [{'text': 'CaseOh banned someone from chat for mentioning ____.',
                                              ...
                                              {'text': 'The horror game stopped being scary once CaseOh encountered '
                                                       '____.',
                                               'pick': 1},
                                              {'text': "Chat's newest nickname for CaseOh is somehow ____.",
                                               'pick': 1},
                                              ...
                                              {'text': 'The stream ended immediately after ____ appeared on screen.',
                                               'pick': 1},
                                              {'text': "In the Brandon Rogers cinematic universe, today's emergency "
                                                       'is ____.',
                                               'pick': 1},
                                              ...
                                              {'text': 'CaseOh opened the fridge and discovered ____ beside ____.',
                                               'pick': 2},
                                              {'text': "Brandon Rogers' newest character is somehow a ____ with "
                                                       '____.',
                                               'pick': 2},
                                              {'text': 'Helen turned a normal grocery trip into an incident '
                                                       'involving ____.',
                                               'pick': 1},
                                              {'text': 'Bryce Tankthrust just acquired a controlling interest in '
                                                       '____.',
                                               'pick': 1},
                                              {'text': 'The neighborhood watch meeting ended after someone admitted '
                                                       'to ____.',
                                               'pick': 1},
                                              ...
                                              {'text': 'Bunny discovered ____ on the kitchen counter and now nobody '
                                                       'is safe.',
                                               'pick': 1},
 ...
 'builtin:hazbin': {'name': 'Hazbin Hotel',
                    'description': 'Hellish hotel management, redemption disasters, radio-demon nonsense, and '
                                   'infernal workplace drama.',
                    'black_cards': [{'text': "Charlie's newest redemption exercise is ____.", 'pick': 1},
                                    ...
                                    {'text': "Lucifer's latest attempt to bond with Charlie involves ____.",
                                     'pick': 1},
                                    {'text': 'Vox interrupted regular programming to complain about ____.',
                                     'pick': 1},
                                    ...
                                    {'text': 'The lobby went completely silent when ____ challenged ____.',
                                     'pick': 2},
                                    ...
                                    {'text': 'Alastor offered to help, which somehow made ____ much worse.',
                                     'pick': 1},
 ...
 'builtin:pokemon': {'name': 'Pokémon',
                     ...
                     'black_cards': [{'text': 'Professor Oak has decided that ____ is a perfectly acceptable starter '
                                     ...
                                     {'text': 'The legendary Pokémon awakened because somebody touched ____.',
                                      'pick': 1},
                                     {'text': 'The newest evil team wants to reshape the world using ____.',
                                      'pick': 1},
 ...
 'builtin:unhinged_internet': {'name': 'Unhinged Internet',
                               'description': 'Brainrot, cursed posts, Discord drama, and terminally online '
                                              'behavior.',
                               'black_cards': [{'text': 'The algorithm ruined my life by recommending ____.',
                                               ...
                                               {'text': 'The apology video would have worked without ____.',
                                                'pick': 1},
                                               {'text': 'I knew the discourse was cooked when people started '
                                                        'defending ____.',
                                                'pick': 1},
                                               ...
                                               {'text': 'The comment section achieved peace by collectively bullying '
                                                        '____.',
                                                'pick': 1},
                                               {'text': 'The internet should have been shut down the moment ____ '
                                                        'went viral.',
                                                'pick': 1},
                                               {'text': 'The comment section achieved sentience after ____.',
                                                'pick': 1},
                                               {'text': 'My screen time report blamed everything on ____.',
                                                'pick': 1},
                                               {'text': 'The algorithm decided my entire personality is ____.',
                                                'pick': 1},
                                               {'text': 'The thread was normal until somebody posted ____.',
                                                'pick': 1},
 ...
 'builtin:family_hell': {'name': 'Family Functions From Hell',
                         'description': 'Holiday dinners, family drama, and reasons to fake a migraine before '
                                        'dessert.',
                         'black_cards': [{'text': 'Thanksgiving ended early after Grandma brought up ____.',
                                          'pick': 1},
                                         ...
                                         {'text': 'The reunion became a crime scene when someone found ____.',
                                          'pick': 1},
                                         {'text': 'Mom said “don’t start” immediately before ____ started.',
                                          'pick': 1},
                                         ...
                                         {'text': 'Thanksgiving dinner stopped when Grandma asked about ____.',
                                          'pick': 1},
                                         {'text': 'The family reunion T-shirt accidentally featured ____.',
                                          'pick': 1},
                                         {'text': 'My aunt brought up ____ before the appetizers arrived.',
                                          'pick': 1},
 ...
 'builtin:bad_parenting': {'name': 'Bad Parenting Decisions',
                           'description': 'Feral household energy, questionable shortcuts, and parenting choices '
                                          'made under pressure.',
                           'black_cards': [{'text': 'The parenting book definitely did not recommend ____.',
                                            'pick': 1},
                                           ...
                                           {'text': 'The reward chart now includes a sticker for not ____.',
                                            'pick': 1},
                                           ...
                                           {'text': 'The school email began with “we need to discuss” and ended with '
                                                    '____.',
                                            'pick': 1},
                                           {'text': 'The parenting group banned me after I suggested ____.',
                                            'pick': 1},
                                           ...
                                           {'text': 'The chore chart now includes “stop putting ____ in ____.”',
                                            'pick': 2},
                                           {'text': 'The pediatrician asked one question about ____ and I '
                                                    'immediately lied.',
                                            'pick': 1}],
 ...
 'builtin:convention': {'name': 'Convention Pack',
                        ...
                        'black_cards': [{'text': 'The cosplay contest was delayed because of ____.', 'pick': 1},
                                        ...
                                        {'text': 'The afterparty died instantly when someone brought ____.',
                                         'pick': 1},
                                        ...
                                        {'text': 'The line for the celebrity photo op was caused by ____.',
                                         'pick': 1},
                                        {'text': 'The cosplay contest was delayed because of ____.', 'pick': 1},
                                        {'text': 'The hotel elevator smelled strongly of ____ all weekend.',
                                         'pick': 1},
                                        {'text': 'Artist Alley sold out of everything except ____.', 'pick': 1},
                                        {'text': 'The con badge should have included a warning about ____.',
                                         'pick': 1},
                                        ...
                                        {'text': 'The panel Q&A immediately went off the rails when someone asked '
                                                 'about ____.',
                                         'pick': 1},
                                        {'text': 'The convention survival kit should always include ____.',
                                         'pick': 1},
 ...
 'builtin:florida_man': {'name': 'Florida Man',
                         'description': 'Alligators, gas stations, hurricanes, and deeply questionable local '
                                        'decisions.',
                         'black_cards': [{'text': 'Florida Man was arrested Tuesday after attempting ____.',
                                          'pick': 1},
                                         {'text': 'The hurricane party was going fine until ____.', 'pick': 1},
                                         {'text': 'The gas station clerk refused service because of ____.',
                                          'pick': 1},
                                         ...
                                         {'text': 'Local news described the incident as “involving” ____.',
                                          'pick': 1},
                                         ...
                                         {'text': 'The local news described the incident as “____ meets ____.”',
                                          'pick': 2},
                                         {'text': 'Florida Man claimed ____ was protected by maritime law.',
                                          'pick': 1},
                                         {'text': 'The HOA sent a cease-and-desist over ____.', 'pick': 1},
                                         {'text': 'The mugshot makes more sense once you know about ____.',
                                          'pick': 1},
 ...
 'builtin:marcus_worm': {'name': 'Marcus the Worm',
                         'description': 'A dedicated pile of server-lore nonsense for Marcus the Worm.',
                         'black_cards': [{'text': 'Marcus the Worm was banned from the kitchen for ____.', 'pick': 1},
                                         {'text': 'The official Marcus lore now includes ____.', 'pick': 1},
                                         {'text': 'Nobody expected Marcus to emerge from ____ carrying ____.',
                                          'pick': 2},
                                         {'text': 'The server voted unanimously to blame Marcus for ____.',
                                          'pick': 1},
                                         ...
                                         {'text': 'We lost Marcus for six hours and found him inside ____.',
                                          'pick': 1},
 ...
 'builtin:group_chat': {'name': 'Group Chat Evidence',
                        'description': 'Screenshots, deleted messages, voice notes, and evidence that should never '
                                       'leave the chat.',
                        'black_cards': [{'text': 'The group chat is legally inadmissible because of ____.',
                                         'pick': 1},
                                        ...
                                        {'text': 'The typing bubble lasted five minutes before they finally sent '
                                                 '____.',
                                         'pick': 1}],
 ...
 'builtin:bathroom_crime': {'name': 'Bathroom Crime Scene',
                            ...
                            'black_cards': [{'text': 'The gas station bathroom was closed indefinitely because of '
                                            ...
                                            {'text': 'The smell could only be described as ____ plus ____.',
                                             'pick': 2},
                                            ...
                                            {'text': 'The bathroom attendant deserves hazard pay for ____.',
                                             'pick': 1},
                                            {'text': 'The smell can only be described as ____.', 'pick': 1},
                                            {'text': 'The toilet survived ____ but finally lost to ____.',
                                             'pick': 2}],
 ...
 'builtin:divorce_court': {'name': 'Divorce Court',
                           ...
                           'black_cards': [{'text': 'The judge visibly sighed after hearing about ____.', 'pick': 1},
                                           ...
                                           {'text': 'The divorce became final after they fought over ____.',
                                            'pick': 1},
                                           ...
                                           {'text': 'Mediation lasted six hours because nobody would surrender ____.',
                                            'pick': 1},
                                           {'text': 'The Facebook relationship status changed during ____.',
                                            'pick': 1},
 ...
 'builtin:blackout_drunk': {'name': 'Blackout Drunk',
                            ...
                            'black_cards': [{'text': 'I woke up with no shoes and a receipt for ____.', 'pick': 1},
                                            ...
                                            {'text': 'The hangover became medically disrespectful after ____.',
                                             'pick': 1},
                                            {'text': 'Apparently I spent forty minutes arguing with ____.',
                                             'pick': 1},
                                            ...
                                            {'text': 'The Uber driver still remembers me because of ____.',
                                             'pick': 1},
 ...
 'builtin:std_speedrun': {'name': 'STD Speed Run',
                          'description': 'Adult hookup chaos, clinic jokes, and decisions that require follow-up '
                                         'testing.',
                          'black_cards': [{'text': 'The clinic receptionist recognized me because of ____.',
                                           'pick': 1},
                                          ...
                                          {'text': 'The pharmacy tech made eye contact after seeing ____ and ____.',
                                           'pick': 2},
                                          {'text': 'The health department called specifically about ____.',
                                           'pick': 1},
                                          ...
                                          {'text': 'The clinic receptionist recognized me because of ____.',
                                           'pick': 1},
 ...
 'builtin:femboy_hooters': {'name': 'Femboy Hooters',
                            ...
                            'black_cards': [{'text': 'Femboy Hooters lost another health inspection because of ____.',
                                            ...
                                            {'text': 'The Femboy Hooters mascot has been replaced with ____.',
                                             'pick': 1},
                                            {'text': 'Employee orientation now includes a section on ____.',
                                             'pick': 1},
                                            ...
                                            {'text': 'The Femboy Hooters employee handbook specifically bans ____.',
                                             'pick': 1},
                                            {'text': 'Tonight’s special comes with fries, ranch, and ____.',
                                             'pick': 1},
                                            ...
                                            {'text': 'The employee of the month award went to ____ for surviving '
                                                     '____.',
                                             'pick': 2},
 ...
 'builtin:invader_zim': {'name': 'Invader Zim',
                         ...
                         'black_cards': [{'text': 'Zim’s latest plan to conquer Earth depends entirely on ____.',
                                         ...
                                         {'text': 'The Irken invasion failed because of ____ and an alarming amount '
                                                  'of ____.',
                                          'pick': 2},
                                         ...
                                         {'text': 'Zim disguised ____ as ____ and somehow fooled everyone.',
                                          'pick': 2},
 ...
 'builtin:helluva_boss': {'name': 'Helluva Boss',
                          'description': 'I.M.P. jobs, infernal workplace disasters, relationship chaos, and very '
                                         'bad decisions.',
                          'black_cards': [{'text': 'The latest I.M.P. contract went off the rails because of ____.',
                                          ...
                                          {'text': 'Moxxie prepared a careful plan, which was immediately replaced '
                                                   'by ____.',
                                           'pick': 1},
                                          ...
                                          {'text': 'Hell’s least professional workplace award goes to ____.',
                                           'pick': 1},
                                          {'text': 'The client wanted revenge. They did not ask for ____.',
                                           'pick': 1},
...
PACK_CATEGORIES: dict[str, tuple[str, str, list[str]]] = {
    ...
    "fandom": ("🎭 Fandom / Events", "Convention and fandom chaos.", [
        ...
        "builtin:hazbin", "builtin:helluva_boss", "builtin:invader_zim", "builtin:youtube_gremlins",
    ]),
...
class CAHSession:
    ...
    def fill_hand(self, player: PlayerState, *, initial: bool = False, avoid: set[str] | None = None) -> None:
        # Keep every unused card exactly where it belongs and refill only missing
        # regular-card slots. Never put duplicate card text into the same live
        # hand; otherwise a duplicate from another selected pack can make a card
        # look like it never left after being played.
        ...
        for card in player.hand:
            if card == BLANK_TOKEN or card in seen:
                continue
            regular_cards.append(card)
            seen.add(card)
            if len(regular_cards) >= regular_target:
                break

        blocked = set(avoid or set()) | set(regular_cards)
    ...
    async def submit(self, user_id: int, cards: list[str], hand_indexes: list[int]) -> tuple[bool, str]:
        async with self.lock:
            ...
            # Make sure the buttons being submitted still point at the same live
            # hand that was shown to the player. This prevents stale ephemeral
            # hand views from removing or preserving the wrong slot.
            submitted_pairs = sorted(zip(hand_indexes, cards), key=lambda pair: pair[0])
            for idx, shown_card in submitted_pairs:
                live_card = player.hand[idx]
                if live_card != BLANK_TOKEN and live_card != shown_card:
                    return False, "That hand is stale. Open your hand again and choose from the fresh cards."
...
class PackCategoryHubView(discord.ui.View):
    ...
    async def all_builtin(self, interaction, _):
        ...
        for pid in BUILTIN_PACKS:
            if pid not in selected:
                selected.append(pid)
        await interaction.response.edit_message(embed=pack_picker_embed(self.setup, self.catalog), view=PackCategoryHubView(self.setup, self.catalog, self.custom_ids))

    @discord.ui.button(label="Clear All", emoji="❌", style=discord.ButtonStyle.secondary, row=2)
    async def clear_all(self, interaction, _):
        self.setup.session.selected_pack_ids = []
        await interaction.response.edit_message(embed=pack_picker_embed(self.setup, self.catalog), view=PackCategoryHubView(self.setup, self.catalog, self.custom_ids))
            ...
            if ok:
                ...
                await interaction.response.edit_message(
                    embed=discord.Embed(
                        ...
                        description="Locked in. Your played card is gone and the replacement is already in your next hand.",
                    ),
                    view=None,
                )
            else:
...
class MemberHubView(discord.ui.View):
    ...
    @discord.ui.button(label="Femboy Hooters Against Humanity",emoji="🃏",style=discord.ButtonStyle.primary,custom_id="mommy:member:cah")
...
def member_hub_embed(guild: discord.Guild) -> discord.Embed:
    ...
    embed.add_field(name=f"🃏 {GAME_NAME}",value="Mix packs • write-ins • Mommy & Daddy • human or AI Czar",inline=False)
