    ...
    async def _handle_solo_segment(
        ...
        async with self._solo_reply_lock(guild.id):
            ...
            try:
                ...
                # One human: Mommy can participate naturally. In any group VC, no
                # matter how large, she only joins after being addressed and then
                # allows follow-ups from that speaker for the active conversation window.
