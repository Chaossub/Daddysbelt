    ...
    async def _handle_solo_segment(
        ...
        async with self._solo_reply_lock(guild.id):
            ...
            try:
                ...
                # One human: Mommy can participate naturally. In group VC she only
                # joins after being addressed, then allows natural follow-ups from
                # that speaker for a short active-conversation window.
                ...
                # Permanent memory remains opt-in-by-addressing: follow-up speech
                # can stay conversational without silently becoming stored memory.
