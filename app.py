...
def health():
    ...
    payload = {
        ...
        "version": "5.2.8-vc-games-cleanup",
    }
...
async def run_bots(settings: Settings) -> None:
    ...
    if settings.mommy_enabled:
        ...
        # Share only the live Mommy bot reference. Daddy uses this to route
        # DM !daddy appeals into Mommy's single universal AppealsCog/backend.
        daddy_bot.mommy_bot = mommy_bot
        tasks.append(
            asyncio.create_task(
