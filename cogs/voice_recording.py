        ...
        try:
            with wav_path.open("rb") as audio:
                result = await self._openai.audio.transcriptions.create(
                    ...
                    prompt=(
                        "Casual Discord voice chat. Preserve profanity, slang, usernames, game names, "
                        "internet phrases, and conversational wording exactly when audible. Use surrounding "
                        "context to avoid guessing common words incorrectly. Do not sanitize speech."
                    ),
                )
