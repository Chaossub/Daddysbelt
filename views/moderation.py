...
def moderation_embed(
    ...
    embed.add_field(
        name="Ban Messages + GIFs",
        value=(
            "Daddy can post a configured ban announcement with an optional "
            "GIF/image. Use **Ban Messages / GIFs** below to manage them."
        ),
        inline=False,
    )
    embed.add_field(
