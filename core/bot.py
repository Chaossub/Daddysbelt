...
class DaddysBeltBot(commands.Bot):
    ...
    async def setup_hook(self):
        ...
        for extension in ("cogs.dashboard","cogs.scheduled_worker","cogs.triggers","cogs.pokemon_stock"):
    ...
    async def on_ready(self):
        ...
        for guild in self.guilds:
            ...
            # setup_hook can run before the guild cache is populated. Sync again
            # here so newly-added subcommands appear immediately in every server.
            try:
